$(document).ready( function () {
    ...
    var cols_html = '';
    COL_TYPE[html_type].forEach(function(currentValue, index){
        cols_html = cols_html + '<li><a href="#" class="toggle-vis" data-column="' + index + '">' + currentValue['data'] + '</a></li>';
    });
    $('.colsVisibility ul').html(cols_html);
